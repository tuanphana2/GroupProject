    ...
    <div>
        <table style="width: 100%; position: center">
            <tr>
                ...
                <td>
                    <asp:Label runat="server" ID="lbtb_PID" TextMode="Number" Style="width: 168px"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddl_PR" runat="server"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox runat="server" ID="txt_PRID"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
